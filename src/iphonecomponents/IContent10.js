  ...
  return (
    <div className="IContent10">
      ...
      <div className="middleTitle">
        <span>
          Download the{" "}
          <span style={{ color: "rgba(95, 61, 255, 1)" }}>DeFiHorse</span> as well
          as the <span style={{ color: "rgba(95, 61, 255, 1)" }}>DeFiHorse</span>{" "}
      ...
      <div className="munityUpdate">
        <div className="updateDiv">
          <div className="Ltext">
            <span>DeFiHorse Community January 2025 Update</span>
          </div>
          <div className="Rdown">
            Download{" "}
            <span>
