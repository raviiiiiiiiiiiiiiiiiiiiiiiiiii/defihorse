      ...
      <div className="topTitle">
        ...
        <div className="title3">
          <span>
            ...
            <span style={{ color: "white" }}>DeFiHorse</span>.Immerse yourself in
            the <span style={{ color: "white" }}>DeFiHorse</span> ecosystem, and
          ...
          <div className="borderTitle centerTitle">
            ...
            <div className="bottomTitle2 bottomTitle">
              <div className="middleIconC">
                <div className="middleIconText">
                  <span>Get</span>
                  <span style={{ color: "#5F3DFF" }}>HorseVerse</span>
                  <span>Tokens</span>
                </div>
              </div>
              <div className="middleText">
                <span>
                  Learn about the{" "}
                  <span style={{ color: "white" }}>$HorseVerse</span> governance
