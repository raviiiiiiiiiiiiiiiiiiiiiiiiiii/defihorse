                    ...
                    <div>
                        ...
                        <div className="title3">
                            <span>
                                ...
                                <span style={{ color: "white" }}>DeFiHorse</span>
                                .Immerse yourself in the{" "}
                                <span style={{ color: "white" }}>DeFiHorse</span>{" "}
                                ecosystem, and get ready for a revolutionary
                ...
                <div className="imgTitle">
                        ...
                        <div className="borderTitle leftTitle">
                            ...
                            <div className="bottomTitle1 bottomTitle">
                                ...
                                <div className="middleText">
                                    <span>
                                        Embark on the thrilling journey of
                                        Stutengarden, the horse-catching game,
                            ...
                            <div className="bottomTitle2 bottomTitle">
                                ...
                                <div className="middleText">
                                    <span>
                                        ...
                                        governance token and its utilities in
                                        the ecosystem.
                                    </span>
                                </div>
                                <div
                    ...
                    <div className="border-gradient3">
                        <div className="borderTitle rightTitle">
                            ...
                            <div className="bottomTitle3 bottomTitle spanbg">
                                <div className="middleIconC">
                                    <div className="middleIconText">
                                ...
                                <div className="middleText">
                                    <span>
                                        The game provides you with majestic 
                                        legendary War Horses that you use to 
                                        compete in infinite Cyberpunk horse races.
                                    </span>
                                </div>
                            </div>
                        </div>
